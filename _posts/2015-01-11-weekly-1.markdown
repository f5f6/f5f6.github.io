...
我们的五楼六楼周刊终于发布了！首期二十多篇，内容涉及语言、Web前端、数据库、架构设计等等，都是编辑们努力原创，或精心挑选的时事文章。我们程序员是热爱技术的一群人，在做项目的同时，也会积累自己的学识。五楼六楼周刊就是这样一群人创建的。我们鼓励原创，注重知识的交流与分享，为改变世界的理想锐意进取。“十年磨一剑，霜刃未曾试。”愿这本周刊成为猿们的磨刀石，茶余饭后时常拿起，从中有所得就更好了。
...
英文原版[Java SE 8 for the Really Impatient](http://it-ebooks.info/book/3677/)

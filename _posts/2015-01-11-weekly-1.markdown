...
: 一个特立独行的MQ系统，名字就是卡夫卡， 变成甲壳虫的卡夫卡， 海量扩展性是它对ActiveMQ， RabbitMQ们骄傲的地方 -- Calvin
...
[Zato ESB](https://zato.io/docs/2.0/)
: ESB(Enterprise Service Bus)本是JavaEE的传统领域。 Zato这个Python的家伙突然进场，还说自己是Written by pragmatists for pragmatists。但感觉因为足够晚进场, 它的功能集，的确是我心目中ESB该有的功能集， 不同于已没听什么人用的ServiceMix，也不同于类库级别的Apache Camel： [中文教程](http://www.infoq.com/cn/articles/zato)，[官方教程](https://zato.io/docs/2.0/tutorial/01.html)， [New in 2.0](https://zato.io/docs/2.0/project/changelog.html) -- Calvin

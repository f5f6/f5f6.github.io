...
: 越来越多的基础组件，在拍胸脯保证运维与扩展性后，在云里以服务的形式提供。也越来越多项目不再愿意自己花精力去运维这些组件，哪怕有现成开源的， 而宁愿选择服务。 除了文中的例子，还有提供Metrics服务的[Librato](https://www.librato.com)， Log管理的[loggly](https://www.loggly.com/) -- Calvin

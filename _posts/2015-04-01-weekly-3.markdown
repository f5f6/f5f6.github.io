...
双周刊有变成月刊的趋势，也许还会变成双月刊、季刊、半年刊、年刊.....为了挽回这个让人忧伤的趋势，周刊需要更多的同志参与贡献内容，请联系江南白衣.....
...
[土人用VirtualBox+CoreOS玩Docker](http://calvin1978.blogcn.com/)
...
: 网上稀缺的深入玩转Graphite的文章，记录项目中采用Graphtie收集业务数据时遇到的问题及解决办法 -- Neway


# 语言，语言，Scala

[同事们关于FP语言讨论](http://aleung.github.io/blog/2015/01/25/fp/)
...
： MQ系统大阅兵，有ActiveMQ, RabbitMQ这些老牌的，有Kafka, NSQ这些新秀 --Bell Fan
